...
public class GitHubAuthController {
    ...
    public ResponseEntity<AuthResponse> githubLogin(
        ...
        try {
            ...
            // Validate state format: must be non-blank, start with "github:" and be long enough
            ...
            if (state == null || state.isBlank() || !state.startsWith("github:") || state.length() < 30) {
                log.warn("GitHub OAuth state validation failed - state malformed or missing, len={}",
